...
func TestService_Cache_HitShortCircuitsProvider(t *testing.T) {
	...
	svc := proxy.NewService(fr, map[string]providers.Client{providers.ProviderAnthropic: provider}, nil, false, 0, nil, c, nil, false, providers.ProviderAnthropic, "claude-haiku-4-5", nil)
...
func TestService_Cache_DisabledByNilCache(t *testing.T) {
	...
	svc := proxy.NewService(fr, map[string]providers.Client{providers.ProviderAnthropic: provider}, nil, false, 0, nil, nil, nil, false, providers.ProviderAnthropic, "claude-haiku-4-5", nil)
