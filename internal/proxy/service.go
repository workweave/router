...
// installation's persisted routing preference ("speed / price / quality"
// dials). Carried as *router.Overrides with only Alpha (quality) and
// SpeedWeight set; the per-request x-weave-routing-* header override takes
// precedence over it. See routingKnobsForRequest.
