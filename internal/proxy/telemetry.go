...
type InsertTelemetryParams struct {
	...
	// PlannerPinModel is the pinned from-model (DecisionModel names the
	// switched-to model on SWITCH rows). Empty/nil when the planner did not
	// run, leaving the columns NULL.
