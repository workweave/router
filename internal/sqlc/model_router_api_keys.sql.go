...
SELECT k.id, k.installation_id, k.external_id, k.name, k.key_prefix, k.key_hash, k.key_suffix, k.last_used_at, k.created_at, k.deleted_at, k.created_by, i.id, i.external_id, i.name, i.created_at, i.updated_at, i.deleted_at, i.created_by, i.excluded_models, i.routing_quality_weight, i.routing_speed_weight
...
func (q *Queries) GetActiveModelRouterAPIKeyWithInstallationByHash(ctx context.Context, keyHash string) (GetActiveModelRouterAPIKeyWithInstallationByHashRow, error) {
	...
	err := row.Scan(
		...
		&i.RouterModelRouterInstallation.RoutingSpeedWeight,
	)
	return i, err
}
