...
prices='{
  "input": {
    ...
    "gpt-5.5-pro":                      0.03,
    "mistralai/mistral-small-2603":     0.0001,
    "moonshotai/kimi-k2.5":             0.00015,
    "qwen/qwen3-235b-a22b-2507":        0.0004,
    "qwen/qwen3-30b-a3b-instruct-2507": 0.0001,
    "qwen/qwen3-coder":                 0.0003,
    "qwen/qwen3-coder-next":            0.0003,
    "qwen/qwen3-next-80b-a3b-instruct": 0.0002,
    "qwen/qwen3.5-flash-02-23":         0.0001
  },
  "output": {
    "claude-haiku-4-5":                 0.004,
    "claude-opus-4-7":                  0.075,
    "claude-sonnet-4-5":                0.015,
    "deepseek/deepseek-v4-flash":       0.0011,
    "deepseek/deepseek-v4-pro":         0.00219,
    ...
    "gpt-5.5-nano":                     0.0006,
    "gpt-5.5-pro":                      0.12,
    "mistralai/mistral-small-2603":     0.0003,
    "moonshotai/kimi-k2.5":             0.002,
    "qwen/qwen3-235b-a22b-2507":        0.0012,
    "qwen/qwen3-30b-a3b-instruct-2507": 0.0003,
    "qwen/qwen3-coder":                 0.0012,
    "qwen/qwen3-coder-next":            0.0012,
    "qwen/qwen3-next-80b-a3b-instruct": 0.0006,
    "qwen/qwen3.5-flash-02-23":         0.0003
  }
}'
